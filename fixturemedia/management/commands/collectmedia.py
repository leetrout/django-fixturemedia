...
class Command(NoArgsCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for root, fixture in json_fixtures:
            ...
            if not file_paths: # try Regex pattern matching double-backslash `\\` paths generated by Windows
                file_paths = file_patt_win.findall(open(fixture).read())
            if file_paths:
